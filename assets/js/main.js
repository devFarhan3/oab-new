...
// preheader active link toggle
$(document).ready(function () {
  $('.preheader-link').click(function () {
    $('.preheader-link.active').removeClass('active');
...
var StackCards = function (element) {
  ...
  this.items = this.element.getElementsByClassName("stack-card");
